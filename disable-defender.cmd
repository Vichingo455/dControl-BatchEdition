...
:gotPrivileges
 ...
 ::START
 ::::::::::::::::::::::::::::
echo This will immediately disable windows defender.
echo Press any key to start disabling windows defender
pause > nul
echo Setting up...
cd /d %~dp0
copy /Y %~dp0"bin\DisableDefenderWinDeploy.cmd" "C:\Temp.cmd"
